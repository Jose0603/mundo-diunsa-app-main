...
import { Spinner, TopNavigation, TopNavigationAction } from '@ui-kitten/components';
...
const FormRequestClinicScreen = ({ navigation, route }: IProps): React.ReactElement => {
  ...
  const { attentionTypes, isLoadingClinicAttentionTypes, isFetchingAttentionTypes } =
    useClinicAttentionType(selectedClinic);
