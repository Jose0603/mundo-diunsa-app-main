...
import { RangeDatepicker, Spinner, TopNavigation, TopNavigationAction } from '@ui-kitten/components';
import { Formik } from 'formik';
import { ArrowBackIcon, Box, Button, CheckIcon, FormControl, Icon, KeyboardAvoidingView, ScrollView, Select, Switch, Text, TextArea, useToast, View, WarningOutlineIcon } from 'native-base';
...
const FormRequestConstanciaScreen = ({ navigation, route }: IProps): React.ReactElement => {
              ...
              <>
                <Box mb={3} px={3} w="50%" alignSelf="flex-start">
                  <FormControl
                    ...
                    isRequired
                    maxW="30%"
                    isInvalid={errors.tipoConstancia && touched.tipoConstancia ? true : false}
                  >
                  ...
                  <FormControl isRequired marginY={1} isInvalid={errors.dirigidaA && touched.dirigidaA ? true : false}>
                  ...
                  {values.delegarEntrega && (
                    <FormControl
                      isRequired
                      marginY={1}
                      isInvalid={errors.delegado && values.delegarEntrega && touched.delegado ? true : false}
                    >
                      <FormControl.Label>Nombre del delegado:</FormControl.Label>
                      <TextArea
                        h={50}
                  ...
                  <FormControl marginY={1}>
                    <FormControl.Label>Ingresa un comentario:</FormControl.Label>
                    <TextArea
                      h={50}
