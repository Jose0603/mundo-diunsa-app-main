...
export default class AnimationScreen<Props> extends Component {
  timeDilation: any;
  durationLongPress: any;
  isTouchBtn: any;
  isLongTouch: any;
  isLiked: any;
  whichIconUserChoose: any;
  currentIconFocus: any;
  previousIconFocus: any;
  isDragging: any;
  isDraggingOutside: any;
  isJustDragInside: any;
  durationAnimationBox: any;
  durationAnimationQuickTouch: any;
  durationAnimationLongTouch: any;
  durationAnimationIconWhenDrag: any;
  durationAnimationIconWhenRelease: any;
  tiltIconAnim: any;
  zoomIconAnim: any;
  zoomTextAnim: any;
  tiltIconAnim2: any;
  ...
  zoomIconAngry: any;
  zoomIconChosen: any;
  zoomIconNotChosen: any;
  zoomIconWhenDragOutside: any;
  zoomIconWhenDragInside: any;
  zoomBoxWhenDragInside: any;
  zoomBoxWhenDragOutside: any;
  pushTextDescriptionUp: any;
  zoomTextDescription: any;
  zoomIconWhenRelease: any;
  moveUpDownIconWhenRelease: any;
  moveLeftIconLikeWhenRelease: any;
  moveLeftIconLoveWhenRelease: any;
  moveLeftIconHahaWhenRelease: any;
  moveLeftIconWowWhenRelease: any;
  moveLeftIconSadWhenRelease: any;
  moveLeftIconAngryWhenRelease: any;
  timerMeasureLongTouch: any;
  soundShortTouchLike: any;
